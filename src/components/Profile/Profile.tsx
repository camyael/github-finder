            ...
            <ProfileContainer>
                ...
                <ProfileDiv>
                    <ProfileUserDiv>
                        ...
                        <p className="profileUser">{profile.login}</p>
                        <p className="profileBio">{profile.bio}</p>
                    </ProfileUserDiv>
                    <ProfileToGithub href={`https://github.com/${profile.login}`} target="_blank">Ir a su github</ProfileToGithub>
                    <ProfileInfo>
                        <ProfileInfoDiv>
                            ...
                            <p>{profile.followers} <span>{profile.followers > 1 ? "seguidores" : "seguidor"}</span></p>
                        </ProfileInfoDiv>
                        <span>.</span>
                        <p>{profile.following} siguiendo</p>
                        <span>.</span>
                        <ProfileInfoDiv>
                            ...
                            <p>{profile.public_repos} {profile.public_repos > 1 ? "repositorios" : "repositorio"}</p>
                        </ProfileInfoDiv>
                    </ProfileInfo>
                    <ProfileMoreInfo>
                        <ProfileInfoDiv>
